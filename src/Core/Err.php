...
/**
 * @date_of_create: 11/23/2021 AD 16:48
 */
...
class Err
{
    ...
    private $status_titles =
        [
            ...
            209 => 'IM Used (HTTP Delta encoding)',
    ...
    public function __construct(int $ErrCode,  $message = '')
    {
        ...
        if (!empty($this->status_translates[$ErrCode])) {
            $this->status_description = $this->status_translates[$ErrCode];
        }
